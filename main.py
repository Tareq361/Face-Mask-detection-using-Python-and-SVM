...
pca=PCA(n_components=100)#dimentin reduction for fast algorithm
    ...
    if flag:
        ...
        for x,y,w,h in faces:
            ...
            if(pred==0):
                ...
                cv2.putText(img,"No Mask",(x,y),font,1,(244,250,250),2)
                print("No mask")
            elif (pred == 2):
                cv2.putText(img, "Incorrect Mask", (x, y), font, 1, (244, 250, 250), 2)
